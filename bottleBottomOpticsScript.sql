...
CREATE TABLE IF NOT EXISTS `mydb`.`sale` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_sale_employee_idx` (`employee_id` ASC) VISIBLE,
  INDEX `fk_sale_client_idx` (`client_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`eyeglasses` (
  ...
  PRIMARY KEY (`id`),
  INDEX `fk_eyeglasses_supplier_idx` (`supplier_id` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`sale_eyeglasses` (
  ...
  INDEX `fk_sale_eyeglasses_eyeglasses_idx` (`eyeglasses_id` ASC) VISIBLE,
